...
image::https://i.imgur.com/ag7w8DP.png["Schéma Architecture", link="https://www.docker.com/", width=1000]
...
*https://github.com/Tructruc/SAE-ALT-S3-Dev-23-24-Occupation-salles-3A-Groupe-2/wiki/Gestion-de-Projet#retour-dexp%C3%A9rience-du-projet[Retrour d’expérience du projet]

=== Backlogs de sprint

* https://github.com/users/Tructruc/projects/3[Sprint 1]
* https://github.com/users/Tructruc/projects/4[Sprint 2]
* https://github.com/users/Tructruc/projects/4[Sprint 3]
