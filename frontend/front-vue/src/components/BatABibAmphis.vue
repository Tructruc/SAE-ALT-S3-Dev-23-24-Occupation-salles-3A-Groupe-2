  ...
  export default {
	...
	setup() {
	  const roomData = reactive({
		  ...
		  Hall: { color: "grey", state: true, path: ["m188 123.96-0.0133 5.889-4.32-0.0644 0.0874-5.2286-1.372-0.0339-9.7582 9.2864 0.11106-4.4754-5.8057-0.1904-0.086 34.098 5.6574-0.0386 0.0397 3.0048 19.361-0.23218 18.037-17.215 2.9621 3.0172-19.953 20.353-10.96 0.16183-0.14615 18.369 5.9836-0.0341 1e-5 6.2723h-14.889v3.0075l-23.215-0.19655-10.762 2.6291-0.0493-4.2243c6.5807-0.2423 15.396-3.9649 16.413-16.84-0.0124-9.1274-7.4313-15.077-13.768-16.373l1.4923-4.1003 10.473 2.2786v-15.151l1e-5 -15.151 3.0003-3.3448 6.0164-0.36965 0.67946-5.9893 2.1345-2.1876 0.71465 0.58503 9.3371 0.0383 17.231-17.515 11.031-0.0477 1e-5 2.7302-8.7371 0.43445v16.891m-1.4075-2.2203 0.0196-14.323-13.506 13.985z"], data: {} },
		  Patio: { color: "grey", state: true, path: ["m182.19 172.52 5.5855-0.0341 0.0155 17.891h-5.6008z", "m167 149.03v-14.106h5.4604v28.212h-5.4604z"], data: {} },
		  ...
		  SAN: { color: "grey", state: true, path: ["m149.03 152.3 4.407 0.37807c-5e-3 3.3654-0.0461 6.8842-0.0683 10.25l-5.8301-1.2692z",
		  ...
		  autres: { color: "grey", state: true, path: ["m193.3 124.06-0.38629 5.4189-2.9972-0.0796-0.0499-5.4027z",
